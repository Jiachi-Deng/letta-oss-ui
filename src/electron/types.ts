...
export type ResidentCoreAgentRecord = SharedAgentRecord;
export type ResidentCoreAgentInfo = SharedAgentRecord;
export type ResidentCoreAgentEntry = SharedAgentRegistryEntry;
export type ResidentCoreAgentActiveResult = SharedAgentActiveResult;
export type ResidentCoreAgentMutationResult = SharedAgentMutationResult;
