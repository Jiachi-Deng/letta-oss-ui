...
export function OnboardingModal({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-ink-900/25 px-4 py-8 backdrop-blur-sm">
      <div className="w-full max-w-xl rounded-2xl border border-ink-900/5 bg-surface p-6 shadow-elevated">
